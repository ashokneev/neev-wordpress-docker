...
import bellwetherLogo from "@/assets/customers/bellwether-coffee.png";
import brilliantEarthLogo from "@/assets/customers/brilliant-earth.png";
import cricutLogo from "@/assets/customers/cricut.png";
import duraflameLogo from "@/assets/customers/duraflame.png";
import restorationHardwareLogo from "@/assets/customers/restoration-hardware.png";
import stitchFixLogo from "@/assets/customers/stitch-fix.png";

const cpgRetailCustomers = [
  { src: bellwetherLogo, alt: "Bellwether Coffee" },
  { src: brilliantEarthLogo, alt: "Brilliant Earth" },
  { src: cricutLogo, alt: "Cricut" },
  { src: duraflameLogo, alt: "Duraflame" },
  { src: restorationHardwareLogo, alt: "Restoration Hardware" },
  { src: stitchFixLogo, alt: "Stitch Fix" },
];

const keyUseCases = [
  { icon: Truck, title: "Supply Chain Optimization", desc: "Demand forecasting, inventory management, supplier relationship management, and predictive analytics for demand planning." },
  { icon: UserCheck, title: "Customer Experience", desc: "Brand loyalty and consumer engagement solutions with personalized, omnichannel customer experiences." },
  { icon: Megaphone, title: "Trade Promotion Management", desc: "Optimize sales strategies with data-driven trade promotion planning, execution, and analysis." },
  { icon: BarChart3, title: "Business Intelligence", desc: "Centralize data from various sources into insightful reports, dashboards, and visualizations for proactive decision-making." },
  { icon: LineChart, title: "Data Analytics", desc: "Derive actionable insights from large volumes of structured and unstructured data to drive competitive advantage." },
  { icon: Package, title: "Demand Forecasting & Inventory", desc: "Minimize stockouts, reduce holding costs, and ensure timely product availability across the supply chain." },
];
...
const weHelpYouAchieve = [
  ...
  { icon: Clock, title: "Faster Time-to-Market", desc: "Accelerate product development and launch cycles by using modern collaboration and project management tools." },
  { icon: UserCheck, title: "Integrated Customer Experience", desc: "Implement an integrated CX solution with customer-centric chatbots and portals for improved engagement, self-service options, and access to resources." },
...
const solutions = [
  { icon: Truck, title: "Supply Chain Optimization", desc: "Leverage cutting-edge digital tools to enhance supply chain processes with real-time tracking and proactive risk management. Improve process efficiency and build resilient supply chains." },
  { icon: UserCheck, title: "Customer Experience", desc: "Implement a comprehensive CX and data platform for data consolidation and real-time analysis. Foster brand loyalty and satisfaction with personalized, responsive customer experiences." },
  { icon: Users, title: "Human Capital Management", desc: "Digitize HCM processes to simplify and automate HR-specific operations. Automated workflows let your team concentrate on delivering quality service and experiences." },
  { icon: Settings, title: "ERP & Business Operations", desc: "Automate and enhance vital back-end business operations including financial management, billing, inventory control, material resource planning, budgeting, and procurement." },
  { icon: TrendingUp, title: "Sales Optimization", desc: "Harness data analytics and predictive modeling to identify sales opportunities, forecast market demand, and optimize resource allocation for effective customer relationship management." },
  { icon: BarChart3, title: "Business Intelligence", desc: "Centralize data from various sources, transforming it into insightful reports, dashboards, and visualizations for real-time KPI monitoring and proactive decision-making." },
];

const howWeHelp = [
  { title: "Application & Data Integration", desc: "Streamline data across accounts, contacts, suppliers, and partners for unified retail operations.", href: "/services/enterprise-integration-services" },
  ...
  { title: "Data & Analytics", desc: "Identify patterns and derive actionable insights for optimized supply chain management, improved customer engagement, and accelerated growth.", href: "/services/data-analytics" },
];
  ...
  return (
    <main className="min-h-screen bg-background overflow-x-hidden relative">
      ...
      <StickyBreadcrumb className="bg-transparent backdrop-blur-none shadow-none border-none">
        ...
        <BreadcrumbSeparator />
        <BreadcrumbItem>
          <BreadcrumbPage>CPG & Retail</BreadcrumbPage>
        </BreadcrumbItem>
      </StickyBreadcrumb>
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity }} className="container mx-auto px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl">
            ...
            <motion.h1 initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ margin: "-50px" }} transition={{ duration: 0.7, delay: 0.15 }} className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-foreground leading-tight tracking-tight">
              ...
              <span className="text-primary">Retail & CPG</span>
            </motion.h1>
            <motion.p initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ margin: "-50px" }} transition={{ duration: 0.7, delay: 0.3 }} className="mt-6 text-lg md:text-xl text-muted-foreground max-w-3xl leading-relaxed">
              As the retail and CPG industry navigates evolving consumer expectations and purchasing behaviors, digital transformation becomes critical. We pioneer automation and streamline business processes, delivering a significant competitive advantage to our customers and their end consumers.
            </motion.p>
            <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ margin: "-50px" }} transition={{ duration: 0.7, delay: 0.45 }} className="mt-8 flex flex-wrap gap-4">
              <Button size="lg" className="rounded-xl shadow-md shadow-primary/15 hover:shadow-lg hover:shadow-primary/25 transition-all" onClick={() => openContactForm("cpg-retail")}>
      ...
      <CustomerLogoSection
        logos={cpgRetailCustomers}
        description="Innovative consumer brands partner with Neev Systems to scale operations and elevate customer experiences."
      />
          ...
          <ParallaxSection speed={0.15}>
            <div className="max-w-3xl mx-auto text-center mb-14">
              ...
              <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ margin: "-100px" }} transition={{ duration: 0.6, delay: 0.15 }} className="text-muted-foreground text-lg">
                Our robust solutions for the CPG and retail industry help you become a data-driven, connected, and agile enterprise.
              </motion.p>
            </div>
          </ParallaxSection>
          ...
          <ParallaxSection speed={0.1}>
            <div className="text-center mb-14">
              ...
              <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ margin: "-100px" }} transition={{ duration: 0.6, delay: 0.1 }} className="text-muted-foreground text-lg max-w-3xl mx-auto">
                Digital disruption powered by emerging technologies addresses industry challenges while fostering resilience and agility.
              </motion.p>
            </div>
          </ParallaxSection>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <ParallaxSection speed={0.12}>
            <div className="text-center mb-14">
              ...
              <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ margin: "-100px" }} transition={{ duration: 0.6, delay: 0.1 }} className="text-muted-foreground text-lg max-w-3xl mx-auto">
                Comprehensive solutions designed for the unique demands of the retail and CPG industry.
              </motion.p>
            </div>
          </ParallaxSection>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <ParallaxSection speed={0.1}>
            <div className="text-center mb-14">
              ...
              <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ margin: "-100px" }} transition={{ duration: 0.6, delay: 0.1 }} className="text-muted-foreground text-lg max-w-3xl mx-auto">
                End-to-end IT ownership from development to support across the entire retail and CPG value chain.
              </motion.p>
            </div>
          </ParallaxSection>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
      ...
      {/* Industry News */}
      <IndustryNewsSection industry="cpg-retail" />

      {/* CTA */}
      <section id="contact-cpg-retail" className="py-20 bg-gradient-to-br from-indigo-200/60 via-blue-100/40 to-sky-100/50 dark:from-indigo-950/50 dark:via-blue-950/35 dark:to-sky-950/30 relative overflow-hidden">
        <div className="pointer-events-none absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-indigo-300/40 to-transparent dark:via-indigo-500/30" />
        ...
        <div className="container mx-auto px-6 lg:px-8 text-center">
          <ParallaxSection speed={0.1}>
            <motion.h2 initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ margin: "-100px" }} transition={{ duration: 0.6 }} className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Ready to Transform Your Retail & CPG Operations?
            </motion.h2>
            <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ margin: "-100px" }} transition={{ duration: 0.6, delay: 0.1 }} className="text-muted-foreground text-lg max-w-2xl mx-auto mb-8">
              Talk to our experts and discover how we can drive digital transformation for your retail and CPG organization.
            </motion.p>
